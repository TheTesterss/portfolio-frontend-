export const DISCORD_WEBHOOK_URL =
    'https://discord.com/api/webhooks/1378338216465268756/1NdHns6QLKH1qdtKPn8XdPYv-J46K7X3ghUQq76J_3wMmA7fYX7lBqYHlDd-5LHPbNZx';
...
export const PROJECTS_CONFIG = [
    ...
    {
        "name": "Base bot discord (Typescript)",
...
export const X_USERNAME = "testers_2222";
